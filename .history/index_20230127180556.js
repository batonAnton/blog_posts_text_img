window.addEventListener('load', () => {
	...
	form.addEventListener('submit', (e) => {
		...
		task_content_el.appendChild(post_input_el);
		...
		post_actions_el.appendChild(task_delete_el);

		task_el.appendChild(post_actions_el);
		...
		post_edit_el.addEventListener('click', (e) => {
			if (post_edit_el.innerText.toLowerCase() == "edit") {
				...
				post_input_el.removeAttribute("readonly");
				post_input_el.focus();
			} else {
				post_edit_el.innerText = "Edit";
				post_input_el.setAttribute("readonly", "readonly");
